...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    // 5 cities
    let vancouver = City(name: "Vancouver", temp: 15, precipitation: 95, icon: "canada", iconUnicode: "\u{1f1e8}\u{1f1e6}", summary: "Rainy")
    let verona = City(name: "Verona", temp: 22, precipitation: 20, icon: "italy", iconUnicode: "\u{1f1ee}\u{1f1f9}", summary: "Cloudy")
    let tokyo = City(name: "Tokyo", temp: 24, precipitation: 40, icon: "japan", iconUnicode: "\u{1f1ef}\u{1f1f5}", summary: "Sunny")
    let saoPaulo = City(name: "Sao Paulo", temp: 32, precipitation: 20, icon: "brazil", iconUnicode: "\u{1f1e7}\u{1f1f7}", summary: "Sunny")
    let seoul = City(name: "Seoul", temp: 35, precipitation: 50, icon: "skorea", iconUnicode: "\u{1f1f0}\u{1f1f7}", summary: "Sunny")
